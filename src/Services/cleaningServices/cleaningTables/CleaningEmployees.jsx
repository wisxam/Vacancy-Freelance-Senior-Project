...
import { usePutCleaningEmployee } from '../hooks/put';
import { useDeleteCleaningEmployee } from '../hooks/delete';
import { useGetCleaningEmployees } from '../hooks/get';
...
const CleaningEmployeesTable = () => {
	...
	const { mutate: updateEmployee } = usePutCleaningEmployee();
	const { mutate: deleteEmployee } = useDeleteCleaningEmployee();
	...
	const { data } = useGetCleaningEmployees(userData?.company?.id);
				...
				<Container maxWidth='lg'>
					<Stack spacing={3}>
						<label>
							...
							{userData?.company?.type} Company Employees
						</label>
						<Box
							sx={{
								width: '100%',
...
export default CleaningEmployeesTable;
