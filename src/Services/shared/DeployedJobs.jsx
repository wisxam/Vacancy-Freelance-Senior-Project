...
import { usePutJobs } from '../hooks/put';
import { useDeleteJobs } from '../hooks/delete';
...
const DeployedJobs = () => {
	...
	const { mutate: updateJob } = usePutJobs();
	const { mutate: deleteJob } = useDeleteJobs();
	...
	const { data } = useGetJobsById(userData?.company?.id);
