...
import { useAddSecurityEmployee } from '../hooks/new';
import {
	employeeRatingsForm,
...
const EmployeeSecurityForm = () => {
	...
	const { mutate: addNewEmployee } = useAddSecurityEmployee();
			...
			<form onSubmit={formik.handleSubmit}>
				<Stack
					...
					<TextField
						...
						variant='filled'>
						{securityStatus_activity.map((option) => (
							<MenuItem
								key={option.value}
								value={option.value}>
								{option.label}
					...
					<TextField
						...
						variant='filled'>
						{securityEmployeeTypes.map((option) => (
							<MenuItem
								key={option.id}
								value={option.name}>
								{option.name}
...
export default EmployeeSecurityForm;
