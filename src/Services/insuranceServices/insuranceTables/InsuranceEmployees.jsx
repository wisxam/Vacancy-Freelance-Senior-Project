...
import { usePutInsuranceEmployee } from '../hooks/put';
import { useDeleteInsuranceEmployee } from '../hooks/delete';
import { useGetInsuranceEmployees } from '../hooks/get';
import { MenuItem } from '@mui/material';
import PageContent from '../../../components/pageContent';
import StarIcon from '@mui/icons-material/Star';
import { employeeInsuranceType } from '../../../Data';
import { employeeRatingsTables } from '../../../Data';
import { status_activity } from '../../../Data';
...
const InsuranceEmployees = () => {
	...
	const { mutate: updateEmployee } = usePutInsuranceEmployee();
	const { mutate: deleteEmployee } = useDeleteInsuranceEmployee();
	...
	const { data } = useGetInsuranceEmployees(userData?.company?.id);
