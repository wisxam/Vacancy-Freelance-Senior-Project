...
import { usePutTransportationEmployees } from '../hooks/put';
...
const TransportationEmployees = () => {
	...
	const { mutate: updateEmployee } = usePutTransportationEmployees();
	const { mutate: deleteEmployee } = useDeleteTransportationEmployee();
	...
	const { data } = useGetTransportationEmployees(userData?.company?.id);
...
export default TransportationEmployees;
